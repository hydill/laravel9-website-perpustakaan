        ...
        <div class="menu-block customscroll mt-4">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li>
                        <a href="/anggota"
                            class="dropdown-toggle no-arrow {{ $title === 'anggota' ? 'activated' : '' }}">
                    ...
                    <li>
                        <a href="/buku"
                            class="dropdown-toggle no-arrow {{ $title === 'buku' ? 'activated' : '' }}">
                            <span class="micon dw dw-book"></span><span class="mtext">Buku</span>
                        </a>
                    </li>
                    <li>
                        <a href="/transaksi"
                            class="dropdown-toggle no-arrow {{ $title === 'transaksi' ? 'activated' : '' }}">
